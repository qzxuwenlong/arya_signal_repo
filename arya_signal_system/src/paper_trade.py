...
PAPER_OBSERVATION_STATES = {'EARLY_DEMON_TREND', 'SECTOR_LAGGARD_OBSERVE', 'SMART_SHORT_PROBE', 'SHORT_CONFIRMING', 'SHORTS_AS_FUEL'}
...
SHORT_STATES = {'SHORT_BREAKDOWN', 'SHORT_ALERT', 'FLASH_CRASH_SHORT', 'SMART_SHORT_PROBE', 'SHORT_CONFIRMING'}
